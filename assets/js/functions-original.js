	...
	$(function(){
		...
		function noResultsCheck() {
			...
			if (numItems == 0) {
				...
				$('.row.projects-wrapper').css("background-image","url(/wp-content/themes/carson/-/media/no-results.png)");
				$('.row.projects-wrapper').css("background-repeat","no-repeat");
				$('.row.projects-wrapper').css("min-height","60px");
		
			} else {

				$('.row.projects-wrapper').removeClass("no-results");
				$('.row.projects-wrapper').css("background-image","");
